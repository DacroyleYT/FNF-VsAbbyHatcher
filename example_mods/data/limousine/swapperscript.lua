...
function onCreatePost()
    if not getPropertyFromClass('ClientPrefs', 'middleScroll') then -- THANK YOU UNUSED SCRIPT ABOVE FOR SAVING ME ALOT OF TIME TRYING TO GET MIDDLESCROLL TO WORK RIGHT
        ...
        --debugPrint('Middlescroll is apparently false')
    end
    if getPropertyFromClass('ClientPrefs', 'middleScroll') then
        noteTweenX("NoteMove1", 0, defaultOpponentStrumX0, 0.1, cubeInOut)
        noteTweenX("NoteMove2", 1, defaultOpponentStrumX1, 0.1, cubeInOut)
        noteTweenX("NoteMove3", 2, defaultOpponentStrumX2, 0.1, cubeInOut)
        noteTweenX("NoteMove4", 3, defaultOpponentStrumX3, 0.1, cubeInOut)
        noteTweenX("NoteMove5", 4, defaultPlayerStrumX0, 0.1, cubeInOut)
        noteTweenX("NoteMove6", 5, defaultPlayerStrumX1, 0.1, cubeInOut)
        noteTweenX("NoteMove7", 6, defaultPlayerStrumX2, 0.1, cubeInOut)
        noteTweenX("NoteMove8", 7, defaultPlayerStrumX3, 0.1, cubeInOut)
        --debugPrint('Middlescroll is apparently true')
    end
end