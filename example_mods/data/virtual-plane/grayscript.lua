...
idle_xml_name = 'Abby idle'
left_xml_name = 'Abby left'
down_xml_name = 'Abby down'
up_xml_name = 'Abby up'
right_xml_name = 'Abby right'
...
name_of_character_xml = 'virtualPlane/Abby-VP'
name_of_character = 'melvinVP'
...
-- if it's set to false the character appears behind the default characters, including gf, watch out for that
foreground = true
...
function onCreate()
    ...
    addAnimationByPrefix(name_of_character, 'fall', 'Abby fall', 12, true);
