...
idle_xml_name = 'Melvin idle'
left_xml_name = 'Melvin left'
down_xml_name = 'Melvin down'
up_xml_name = 'Melvin up'
right_xml_name = 'Melvin right'
...
name_of_character_xml = 'MelvinMelvinJr'
name_of_character = 'melvin'
...
function onCreate()
	...
	--addAnimationByPrefix(name_of_character, 'singLEFTmiss', left_miss_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singDOWNmiss', down_miss_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singUPmiss', up_miss_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singRIGHTmiss', right_miss_xml_name, 12, false);

	--addAnimationByPrefix(name_of_character, 'singLEFT-alt', left_alt_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singDOWN-alt', down_alt_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singUP-alt', up_alt_xml_name, 12, false);
    --addAnimationByPrefix(name_of_character, 'singRIGHT-alt', right_alt_xml_name, 12, false);

    --setPropertyLuaSprite(name_of_character, 'x', x_position)
    --setPropertyLuaSprite(name_of_character, 'y', y_position)
...
function onCreatePost(runtime)
    scaleObject('melvin', 1.1, 1.1);
end