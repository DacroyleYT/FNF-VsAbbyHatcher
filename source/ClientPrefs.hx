...
class ClientPrefs {
	public static var legacyMenu:String = 'freakyMenu';
	...
	public static var language:String = "English (US)";
	...
	public static function saveSettings() {
		FlxG.save.data.legacyMode = legacyMode;
		FlxG.save.data.downScroll = downScroll;
		FlxG.save.data.language = language;
		var langsClass = new Languages();
		langsClass.loadLanguage(language);
	...
	public static function loadPrefs() {
		if(FlxG.save.data.legacyMode != null) {
			downScroll = FlxG.save.data.legacyMode;
			if (legacyMode) {
				legacyMenu = 'freakyMenu-old';
			} else {
				legacyMenu = 'freakyMenu';
			}
		}
